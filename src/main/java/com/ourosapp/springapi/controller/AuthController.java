...
/**
 * Controlador REST responsável pela autenticação de usuários e emissão de tokens JWT.
 * Disponibiliza rotas públicas de login para Administradores, Funcionários da Empresa e Produtores Rurais.
 */
@RestController
